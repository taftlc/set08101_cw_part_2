...
const situations = [{
		...
		a: [{ text: "Mountains", next_situation: 2, ss_flag: 0 },
	...
	},
	{
		...
		a: [{text: "Proceed", next_situation: 3, ss_flag: 0 },
			{text: "Proceed", next_situation: 3, ss_flag: 0 }
		]
	},
	{
		id: 3,
		q: "On the radio there is a weather report of a big storm blowing in. Maybe you should wait for better weather?",
		a: [{text: "No, go anyway.", next_situation: 6, ss_flag: 2 },
			{text: "Yes, wait for it to clear.", next_situation: 4, ss_flag: 1 }
		]
	},
	{
		id: 4,
		q: "You choose to wait for better weather.",
		a: [{text: "Proceed", next_situation: 5, ss_flag: 0 },
			{text: "Proceed", next_situation: 5, ss_flag: 0 }
		]
	},
	{
		id: 5,
		q: "A week later you have another long weekend and with a clear forecast you begin preparations.",
		a: [{text: "Proceed", next_situation: 8, ss_flag: 0 },
			{text: "Proceed", next_situation: 8, ss_flag: 0 }
		]
	},
	/*{
		id: 6,
	...
	},
	{
		...
		a: [{text: "Take the light-weight gear", next_situation: 33, ss_flag: 2 },
			{text: "Take heavier gear", next_situation: 9, ss_flag: 1 }
		]
	},
	{
		id: 9,
		...
		a: [{text: "Proceed", next_situation: 10, ss_flag: 0 },
			{text: "Proceed", next_situation: 10, ss_flag: 0 }
		]
	},
	{
		id: 10,
		...
		a: [{text: "Take the well trod trail.", next_situation: 11, ss_flag: 1 },
			{text: "As the crow flies. Take the direct path.", next_situation: 22, ss_flag: 2 }
		]
	},
	{
		id: 11,
	...
	},
	{
		...
		a: [{text: "Proceed", next_situation: 21, ss_flag: 0 },
			{text: "Proceed", next_situation: 21, ss_flag: 0 }
		]
	},
	{
		id: 21,
	...
	},
	{
		...
		a: [{text: "Proceed", next_situation: 24, ss_flag: 0 },
			{text: "Proceed", next_situation: 24, ss_flag: 0 }
		]
	},
	{
		id: 24,
		...
		a: [{text: "Search for the dry wood", next_situation: 31, ss_flag: 0 },
			{text: "Focus your efforts on lighting the meagre and wet stash you have", next_situation: 25, ss_flag: 0 }
		]
	},
	{
		id: 25,
	...
	},
	{
		...
		a: [{text: "Proceed", next_situation: 32, ss_flag: 0 },
			{text: "Proceed", next_situation: 32, ss_flag: 0 }
		]
	},
	{
		id: 32,
	...
	},
	{
		...
		a: [{text: "Proceed", next_situation: 34, ss_flag: 0 },
			{text: "Proceed", next_situation: 34, ss_flag: 0 }
		]
	},
	{
		id: 34,
		q: "After a winding drive you find a small car park and prepare to leave your vehicle to hike the rest on foot. A quick glance at your compass and you are able to plot a direct course to where the campsite is supposed to be: due west. Before stepping out you spot a well trod trail leading in the same direction. Should you take the winding trail or set straight out on the most direct path available?",
		a: [{text: "Take the well trod trail.", next_situation: 35, ss_flag: 1 },
			{text: "As the crow flies. Take the direct path.", next_situation: 49, ss_flag: 2 }
		]
	},
	{
		id: 35,
	...
	},
	{
		...
		a: [{text: "Proceed", next_situation: 43, ss_flag: 0 },
			{text: "Proceed", next_situation: 43, ss_flag: 0 }
		]
	},
	{
		id: 43,
		...
		a: [{text: "No, follow the trail", next_situation: 44, ss_flag: 1 },
			{text: "Yes, the direct route will save time", next_situation: 46, ss_flag: 2 }
		]
	},
	{
		id: 44,
		q: "You take the winding trail back and arrive at your vehicle without any fanfare. Loading your stuff you prepare to leave.",
		a: [{text: "Proceed", next_situation: 45, ss_flag: 0 },
			{text: "Proceed", next_situation: 45, ss_flag: 0 }
		]
	},
	{
		id: 45,
	...
	},
	{
		...
		a: [{text: "Proceed", next_situation: 48, ss_flag: 0 },
			{text: "Proceed", next_situation: 48, ss_flag: 0 }
		]
	},
	{
		id: 48,
	...
	},
	{
		id: 50,
		q: "Sheer cliff faces and long ravines force you to retrace your steps several different times. Eventually you are able to find your way back to the head of the trail. After losing several hours of daylight you decide to follow the trail.",
		a: [{text: "Proceed", next_situation: 51, ss_flag: 0 },
			{text: "Proceed", next_situation: 51, ss_flag: 0 }
		]
	},
	{
		id: 51,
		q: "You find a stash of firewood left by a previous 'tenant'. It is slightly wet so you take care to stack it by the fire pit. The night is coming on quickly now and you have only a meagre stash of fuel. Maybe there is some dry wood nearby...",
		a: [{text: "Search for the dry wood", next_situation: 52, ss_flag: 0 },
			{text: "Focus your efforts on lighting the meagre and wet stash you have", next_situation: 54, ss_flag: 0 }
		]
	},
	{
		id: 52,
		q: "You grab your flashlight and head out to find anything that would make better fuel.",
		a: [{text: "Proceed", next_situation: 53, ss_flag: 0 },
			{text: "Proceed", next_situation: 53, ss_flag: 0 }
		]
	},
	{
		id: 53,
	...
	},
	{
		id: 57,
		q: "Its now fully dark out and you make preparations to rest.",
		a: [{text: "Proceed", next_situation: 58, ss_flag: 0 },
			{text: "Proceed", next_situation: 58, ss_flag: 0 }
		]
	},
	{
		id: 58,
